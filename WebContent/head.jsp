            ...
            <div class="container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="<s:url action="welcomeLink"/>" >
                               <!-- <img src="images/csc.png" alt=""> <img src="images/zip2017.gif" alt="">  -->
			    			Automate Web Design & Reuse - Zurich
                        </a>			    
                    </div>
                ...
                <nav class="collapse navbar-collapse navbar-right" role="navigation">
                    <div class="main-menu">
                        <ul class="nav navbar-nav navbar-right">
                            ...
                            <li><a href="<s:url action="aboutLink"/>">About</a></li>
                          ...
                          <!--  <li class="dropdown">
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <ul>
                                        <li><a href="<s:url action="generateLink"/>"> Generate Web Page </a></li>
