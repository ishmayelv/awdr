                    ...
                    <div class="col-md-12 text-center">
                        <div class="block wow fadeInUp" data-wow-delay=".3s">
                            ...
                            <section class="cd-intro">
                                ...
                                <span>INVEST ONCE & REAP BENEFITS, FROM FUTURE DESIGNS AND ENHANCEMENTS </span><br>
                                <span class="cd-words-wrapper">
                                    <b class="is-visible">ZURICH - CSC</b>                                    
                                </span>
                                </h1>
                                </section> <!-- cd-intro -->
                                <!-- /.slider -->
                                <h2 class="wow fadeInUp animated" data-wow-delay=".6s" >
                                    Let us make applications more user Friendly, Device independent, Browser independent without investing/ vesting DOLLAR,<br>
								    No restriction to Customer/Zurich while accessing Zurich applications and become a leader of more user friendly.<br>
								    Reusing code, ZURICH you control your look and feal with  very less and minimal effort, Your applications !!
							    </h2>
							   
                               <a class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green" data-wow-delay=".9s" 
                                  href="#works" data-section="#works" >View Works</a>
                ...
                <div class="container">
                    <div class="section-heading">
                        ...
                        <p class="wow fadeInDown" data-wow-delay=".5s">
                            ...
                            Aenean posuere <br> tortor sed cursus feugiat, nunc augue blandit nunc, eu sollicitudin urna dolor sagittis lacus.
                        </p>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="block">
                                ...
                                <p class="wow fadeInDown" data-wow-delay=".5s" data-wow-duration="500ms">Lorem ipsum dolor sit amet, consectetur adipisicing elit. 
                                    Nobis,<br>possimus commodi, fugiat magnam temporibus vero magni recusandae? Dolore, maxime praesentium.</p>
